...
// e.stopPropagation();
    ...
    //             // console.log(document.querySelector('.auth-menu').style.left)
    //             // If menu is displayed
    //             if (!document.querySelector('#mobile-nav').checked) {
    //                 // If menu is displayed
    //                 // if (document.querySelector('.menu').style.left !== '100%') {
    //                 // Hide menu
    //                 // document.querySelector('.auth-menu').style.setProperty('left', '70%');
    //                 document.querySelector('#mobile-nav').checked = 'true';
    //                 // }
    //                 // else {
    //                 // Hide menu
    ...
    //             }
    //             else {
    //                 // document.querySelector('.auth-menu').style.setProperty('left', '100%');
